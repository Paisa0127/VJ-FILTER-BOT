...
API_ID = int(environ.get('API_ID', '23871891'))
...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7169327432').split()] # For Multiple Id Use One Space Between Each.
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002486686363').split()]  # For Multiple Id Use One Space Between Each.
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Chintu:Chintu@cluster0.nt4pw.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
SHORTLINK_API = environ.get('SHORTLINK_API', '57d691f764e03aed485f68abeffbbb141addcfed')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/modijiurltutorial/6') # How Open Shortner Link Video Link , Channel Link Where You Upload Your Video.
